...
class MatrizDeAccesoTest extends TestCase
{
    ...
    {
        // /destacados queda afuera a propósito: solo existe si el negocio
        // eligió una marca destacada, así que sin configurar da 404 (ver
        // FronteraPublicoAdminTest, que sí la configura y la recorre).
        foreach (['/', '/productos', '/combos', '/ofertas', '/nuevos', '/carrito', '/sitemap.xml'] as $ruta) {
