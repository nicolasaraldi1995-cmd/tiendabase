...
class FronteraPublicoAdminTest extends TestCase
{
    ...
    private function catalogoConValoresMarcados(): array
    {
        ...
        // Sin marca destacada elegida, /destacados no existe (404): se
        // configura para que el barrido llegue también a esa página.
        Configuracion::actual()->update(['marca_destacada_id' => $marca->id]);
