        ...
        return [
            ...
            Actions\Action::make('recordar_pago')
                ...
                ->url(function () {
                    ...
                    $negocio = Configuracion::actual()->nombre_negocio;
                    $mensaje = "Hola {$nombre}! Te recordamos que tenés un saldo pendiente de \${$saldo} correspondiente a tu pedido #{$this->record->id} en {$negocio}. Cualquier consulta, quedamos a disposición. ¡Gracias!";
