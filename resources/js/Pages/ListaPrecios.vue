...
<template>
    <Head title="Lista de precios">
        <meta name="description" :content="`Lista de precios actualizada de ${$page.props.negocio.nombre}. Consultá productos, marcas y presentaciones.`" />
    </Head>
    <PublicLayout>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                ...
                <div class="flex gap-2 shrink-0">
                    ...
                    <a :href="route('lista-precios.planilla')" class="inline-flex items-center gap-2 bg-surface-2 hover:bg-surface-3 text-text-secondary text-[13px] font-medium px-4 py-2.5 rounded-xl transition-all border border-border"
                        title="Planilla para editar los precios en Excel y volver a subirla al Importador">
                        Planilla
                    </a>
