...
<div style="font-family:Inter,Arial,sans-serif;max-width:500px;margin:0 auto;padding:30px;background:#f4f2ee;color:#1a1d21;">
    ...
    <p style="color:#9a9da5;font-size:12px;margin-top:30px;">{{ $negocio->nombre_negocio }}@if($negocio->eslogan) — {{ $negocio->eslogan }}@endif @if($negocio->ciudad) · {{ $negocio->ciudad }}@endif</p>
</div>
